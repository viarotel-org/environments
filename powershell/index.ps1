...
# 手动刷新 https://purge.jsdelivr.net/gh/viarotel/scripts@main/powershell/windows-virtual-monitor/index.ps1
$scriptUrls = @{
    "windows-virtual-monitor" = "https://cdn.jsdelivr.net/gh/viarotel/scripts@main/powershell/windows-virtual-monitor/index.ps1";
}
