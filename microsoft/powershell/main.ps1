...
# 手动刷新 https://purge.jsdelivr.net/gh/viarotel/scripts@main/powershell/windows-virtual-monitor/main.ps1
$scriptUrls = @{
    "windows-virtual-monitor" = "https://cdn.jsdelivr.net/gh/viarotel/scripts@main/microsoft/powershell/windows-virtual-monitor/main.ps1";
}
